...
#ifndef DRAWER_FRAMEDRAWER_H
#define DRAWER_FRAMEDRAWER_H
...
public:
  ...
  /** @brief Update info from the last processed frame.
   * @param pTracker
   */
   ...
   * @param bOldFeatures
   * @return cv::Mat of the frame
   */
  cv::Mat DrawFrame(bool bOldFeatures = true);

  /** @brief Draw right last processed frame.
   * @return cv::Mat of the frame
   */
...
protected:
  /** @brief Draw the text info of the frame.
   * @param im : Image to draw
   * @param nState : State of the system
   * @param imText : Image with the text
   */
