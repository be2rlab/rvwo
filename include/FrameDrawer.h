...
class FrameDrawer {
 public:
  ...
  // Draw last processed frame and its keyframe.
 ...
 protected:
  ...
  cv::Mat mIm, mImRight, mImKF;
  int N;
  vector<cv::KeyPoint> mvCurrentKeys, mvCurrentKeysRight, mvCurrentMovKeys, mvKFMovKeys, mvKFSegKeys;
