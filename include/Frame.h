...
class Frame {
 public:
  ...
  // Constructor for stereo cameras with Segmentation.
  Frame(const cv::Mat &imLeft, const cv::Mat &imRight, const cv::Mat &imSeg,
 ...
 public:
  ...
  cv::Mat mDescriptors, mDescriptorsRight, mDynDescriptors;
