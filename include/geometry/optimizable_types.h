...
#include <third_party/g2o/g2o/types/sim3.h>
 ...
 * This class is used to define the edge between a vertex of type
 * g2o::VertexSE3Expmap and a 2D point
 */
 ...
 * This class is used to define the edge between a vertex of type
 * g2o::VertexSBAPointXYZ and a vertex of type VertexSim3Expmap
 */
class EdgeSim3ProjectXYZ
    : public g2o::BaseBinaryEdge<2, Eigen::Vector2d, g2o::VertexSBAPointXYZ,
                                 RVWO::VertexSim3Expmap> {
public:
  /** @brief Constructor of the class
   */
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW
   ...
   */
  void computeError() {
    const RVWO::VertexSim3Expmap *v1 =
        static_cast<const RVWO::VertexSim3Expmap *>(_vertices[1]);
    const g2o::VertexSBAPointXYZ *v2 =
        static_cast<const g2o::VertexSBAPointXYZ *>(_vertices[0]);
