...
#include "third_party/g2o/g2o/core/sparse_block_matrix.h"
...
public:
   ...
   */
  static bool sortByVal(const pair<MapPoint *, int> &a,
   ...
   */
  void static LabelToProb(const cv::KeyPoint &kpUn, const float &kpSegVal,
  ...
  /** @brief  Marginalize block element (start:end,start:end). Perform Schur
