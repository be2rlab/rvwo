...
#ifndef MAP_TRACKING_H
#define MAP_TRACKING_H
...
#include "third_party/Sophus/sophus/interpolate.hpp"
...
public:
  ...
  Sophus::SE3f GrabImageStereoSegment(const cv::Mat &imRectLeft,
                                      const cv::Mat &imLeftSeg,
                                      const cv::Mat &imRectRight,
                                      const double &timestamp, string filename);
  Sophus::SE3f GrabImageRGBD(const cv::Mat &imRGB, const cv::Mat &imD,
                             const double &timestamp, string filename);
  Sophus::SE3f GrabImageRGBDSemantic(const cv::Mat &imRGB, const cv::Mat &imD,
                                     const cv::Mat &imSeg,
                                     const double &timestamp, string filename);
...
protected:
  ...
  // Vector of wheel odometry measurements from previous to current frame
  std::vector<ODOM::Meas> mvOdomFromLastFrame;
  //  RVWO::ODOM::Meas LastOdomMeas;
