...
Eigen::Vector3d Converter::img2Cam (const Eigen::Vector2d& px, const double& depth, const Eigen::Vector4d& K)
{
  float fx_ = K[0];
  float fy_ = K[1];
  float cx_ = K[2];
...
Eigen::Vector2d Converter::cam2Img (const Eigen::Vector3d& ptc, const Eigen::Vector4d& K) 
{
  float fx_ = K[0];
  float fy_ = K[1];
  float cx_ = K[2];
