...
namespace ORB_SLAM3 {
    ...
    LocalMapping::LocalMapping(System *pSys, Atlas *pAtlas, const float bMonocular,
                               bool bInertial, const int kernel, const string &_strSeqName)
            : mpSystem(pSys),
...
//      cv::imwrite("/home/wfram/Datasets/rgbd_dataset_freiburg3_walking_xyz/TestKF/"+std::to_string(mpCurrentKeyFrame->mnId)+".png",
//                  imgKFDebug);
...
//      if (!mpCurrentKeyFrame->gray_.empty()) {
                ...
                cv::imwrite("/home/wfram/Datasets/rgbd_dataset_freiburg3_walking_xyz/TestKF/" +
                            ...
                            imgKFDebug);
//      }
//      cv::imwrite("/home/wfram/Datasets/rgbd_dataset_freiburg3_walking_xyz/TestKF/"+std::to_string(mlProcessdKFs.front()->mnId)+".png",
//                  mlProcessdKFs.front()->gray_.clone());
...
//  cv::waitKey(1);
        cv::imwrite(
                "/home/wfram/Datasets/rgbd_dataset_freiburg3_walking_xyz/Test/" + std::to_string(pKF->mnId) + ".png",
                img);
